          ...
          <div className="flex-grow flex flex-col">
            ...
            <div className="">
              <div className="p-4">
                ...
                <Link to="/cart" className="w-full block bg-gray-100 hover:bg-gray-200 p-2 text-center mb-2 rounded-md text-sm" onClick={() => setIsOpen(false)}>
                  مشاهده سبد خرید
                </Link>
                <Link to="/checkout" className="w-full block bg-primary hover:opacity-80 p-2 text-center text-white rounded-md text-sm" onClick={() => setIsOpen(false)}>
                  تسویه حساب
                </Link>
              </div>
            </div>
