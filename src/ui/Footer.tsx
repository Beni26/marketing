...
const Footer = () => {
  ...
  return (
    <footer>
      <section className="relative bg-gray-200 bg-layerFooter  bg-[top_center]   bg-no-repeat  w-full pt-20 pb-12 mb-14">
        <div
          className="absolute top-[-25px]  w-16 h-16 cursor-pointer  rounded-full bg-primary text-white flex justify-center items-center hover:top-[-35px] transition-all ease-in-out duration-300"
          style={{ right: "calc(50% - 32px)" }}
          onClick={scrollToTop}
        >
          <TbArrowBigUpLines size="25px" />
        </div>
        <div className="absolute bottom-0 left-0 w-full overflow-hidden rotate-180">
          <svg
            ...
            className="relative h-7 w-full overflow-hidden left-1/2 translate-x-[-50%]"
          >
            <path
              className="elementor-shape-fill fill-white origin-center "
              d="M1000,4.3V0H0v4.3C0.9,23.1,126.7,99.2,500,100S1000,22.7,1000,4.3z"
            ></path>
          </svg>
        </div>
        <div className="container xl:max-w-screen-xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-5 p-3">
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <span className="text-sm">امکان تحویل اکسپرس</span>
            </div>
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <span className="text-sm"> امکان پرداخت در محل</span>
            </div>
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <span className="text-sm"> 7روز هفته، 24 ساعته</span>
            </div>
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <span className="text-sm">7روزضمانت بازگشت کالا</span>
            </div>

            <div className="flex flex-col justify-center items-center gap-2  md:col-span-2 lg:col-span-1">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="54"
              ...
              <span className="text-sm"> ضمانت اصل بودن کالا</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="container xl:max-w-screen-xl pl-4 pr-4 md:pl-0 md:pr-0">
        <div className="lg:flex gap-6 mb-20">
          <div className="flex justify-center  gap-6 lg:flex-col lg:gap-2">
            <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-primary hover:scale-90 transition-all ease-in-out duration-100  cursor-pointer ">
              <FaFacebook className="text-white" size="22px" />
            </div>
            <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-primary hover:scale-90 transition-all ease-in-out duration-100  cursor-pointer ">
              <FaYoutube className="text-white" size="22px" />
            </div>

            <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-primary hover:scale-90 transition-all ease-in-out duration-100  cursor-pointer ">
              <BsTelegram className="text-white" size="22px" />
            </div>

            <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-primary hover:scale-90 transition-all ease-in-out duration-100  cursor-pointer ">
              <FaTwitter className="text-white" size="22px" />
            </div>
          </div>
          ...
          <div>
            <div className="mb-3">
              <img
                src="https://theme.fullwp.ir/ecolive/home-10/wp-content/uploads/2023/03/logo-2.png"

                className="lg:w-[165px] lg:h-[66px] w-1/2 h-auto"
                alt=""
              />
            </div>
            <p className="text-gray-500 text-justify text-sm md:text-lg leading-relaxed">
        ...
        <div className="grid grid-col-2 lg:grid-cols-7 pr-5 gap-5">
          <div>
            <h2 className="font-bold text-lg">لینک های مهم</h2>
            <ul className="mt-6 list-disc  space-y-3">
              <li className="text-primary">
                <span className="text-accent">تماس با اکولایو</span>
              </li>
              <li className="text-primary">
                <span className="text-accent">درباره اکولایو </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> وبلاگ اکولایو </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> فروش در اکولایو </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-6 list-disc  space-y-3">
              <li className="text-primary">
                <span className="text-accent"> پاسخ به پرسش ها </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> رویه های بازگرداندن کالا </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> شرایط استفاده </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> فرصت های شغلی </span>
              </li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-lg"> همکاری با ما </h2>
            <ul className="mt-6 list-disc  space-y-3">
              <li className="text-primary">
                <span className="text-accent"> حریم خصوصی </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> گزارش باگ </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> نحوه ثبت سفارش </span>
              </li>
              <li className="text-primary">
                <span className="text-accent"> رویه ارسال سفارش </span>
              </li>
            </ul>
          </div>

          <div className="col-span-2">
            <h2 className="font-bold text-lg"> ارتباط با اکولایو مارکت </h2>
            <ul className="mt-6   space-y-5">
              ...
              <li>
                <div className="flex gap-4">
                  ...
                  <span className="text-sm">021-55665566 | 021-55665566</span>
                </div>
              </li>
              ...
              <li>
                <div className="flex gap-4">
                      ...
                      <g id="Iconly/Curved/Light/Location">
                        <g id="Location">
                          <path
                            ...
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M14.5103 10.7107C14.5103 9.32938 13.391 8.21014 12.0097 8.21014C10.6295 8.21014 9.51025 9.32938 9.51025 10.7107C9.51025 12.0909 10.6295 13.2101 12.0097 13.2101C13.391 13.2101 14.5103 12.0909 14.5103 10.7107Z"
                            stroke="#6A6A6A"
                            strokeWidth="1.5"
                            strokeLinejoin="round"
                          ></path>
                          <path
                            ...
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M11.9995 21.0001C9.10148 21.0001 4.5 15.9588 4.5 10.5988C4.5 6.40259 7.8571 3.00012 11.9995 3.00012C16.1419 3.00012 19.5 6.40259 19.5 10.5988C19.5 15.9588 14.8985 21.0001 11.9995 21.0001Z"
                            stroke="#6A6A6A"
                            strokeWidth="1.5"
                            strokeLinejoin="round"
                          ></path>
                  ...
                  <span>ایران - تهران - خیابان فردوسی کوچه نهم</span>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-2">
            <h2 className="font-bold text-lg"> به ما اعتماد کنید</h2>
            <div className="flex mt-6 ">
              <img
                src="https://theme.fullwp.ir/ecolive/home-10/wp-content/uploads/2023/03/New-Project-3-1.png"
                width="100px"
                height="100px "
                alt=""
                className="flex-grow"
              />
              <img
                src="https://theme.fullwp.ir/ecolive/home-10/wp-content/uploads/2023/03/New-Project-1-1.png"
                width="100px"
                height="100px "
                alt=""
                className="flex-grow"
              />
              <img
                src="https://theme.fullwp.ir/ecolive/home-10/wp-content/uploads/2023/03/New-Project-3.png"
                width="100px"
                height="100px"
                alt=""
                className="flex-grow"
        ...
        <div className="flex justify-between text-accent mt-16 items-center">
          <p className="text-accent text-sm">
            © کپی رایت | 2023 | برند شما. تمامی حقوق محفوظ است.
          </p>
          <p className="text-accent text-sm">All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
